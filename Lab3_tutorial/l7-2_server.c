...
int main(int argc, char **argv)
{
    ...
    N_shared[0] = N; // trzymamy N_shared jako "jednoelementowego stringa" => char => bajt => liczba od 0 do 255
    ...
    // Tworzenie współdzielonego mutexa
    ...
    while(1) 
    {
        ...
        for(int i = 0; i < N; i++) 
        {
            ...
            putchar('\n'); // wypisanie jednego znaku do stdout
        }
